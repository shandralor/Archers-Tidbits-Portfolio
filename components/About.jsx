            ...
            <div className='max-w-[1240px] md:m-auto md:grid grid-cols-3 gap-8 mx-12'>
                <div className='col-span-2 '>
                    ...
                    <div className='text-xl tracking-wider text-gray-800'>
                        ...
                        <p>When I caught the traditional archery bug almost five years ago, it was because of Armin's videos.</p>
                    ...
                    <h2 className='my-8 text-2xl border-t pt-4 text-white'>So if you would like to join me on this every continuing journey of learning and creating, please let me know and I'll try to build you what you want!</h2>
                </div>
